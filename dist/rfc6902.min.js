...
return l}function w(a,b,e,g){g=void 0===g?w:g;if(a===b)return[];var l=k(a),n=k(b);return"array"==l&&"array"==n?J(a,b,e,g):"object"==l&&"object"==n?M(a,b,e,g):[{op:"replace",path:e.toString(),value:b,original:a}]}function D(a,b,e){Array.isArray(a)?"-"==b?a.push(e):(b=parseInt(b,10),a.splice(b,0,e)):a[b]=e}function E(a,b){Array.isArray(a)?(b=parseInt(b,10),a.splice(b,1)):delete a[b]}function N(a,b){a=p.fromJSON(b.path).evaluate(a);if(null===a.parent)return new v(b.path);if(Array.isArray(a.parent)){if(parseInt(a.key,
