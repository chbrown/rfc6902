...
void 0!==l[n]&&(e[n]=(e[n]||0)+1)}for(var y in e)e[y]<b&&delete e[y];return Object.keys(e)}function B(a,b){return{operations:a.operations.concat(b),cost:a.cost+1}}function J(a,b,e,g){function l(p,m){var t=p+","+m,r=n[t];if(void 0===r){if(0<p&&0<m&&!g(a[p-1],b[m-1],new q).length)r=l(p-1,m-1);else{r=[];if(0<p){var z=l(p-1,m);r.push(B(z,{op:"remove",index:p-1,original:a[p-1]}))}0<m&&(z=l(p,m-1),r.push(B(z,{op:"add",index:p-1,value:b[m-1]})));0<p&&0<m&&(z=l(p-1,m-1),r.push(B(z,{op:"replace",index:p-1,
original:a[p-1],value:b[m-1]})));r=r.sort(function(K,L){return K.cost-L.cost})[0]}n[t]=r}return r}g=void 0===g?w:g;var n={"0,0":{operations:[],cost:0}},y=isNaN(a.length)||0>=a.length?0:a.length,C=isNaN(b.length)||0>=b.length?0:b.length;C=l(y,C).operations;return $jscomp.makeIterator(C.reduce(function(p,m){var t=$jscomp.makeIterator(p);p=t.next().value;t=t.next().value;if("add"===m.op){var r=m.index+1+t;m={op:m.op,path:e.add(r<y+t?String(r):"-").toString(),value:m.value};return[p.concat(m),t+1]}if("remove"===
m.op)return m={op:m.op,path:e.add(String(m.index+t)).toString(),original:m.original},[p.concat(m),t-1];r=e.add(String(m.index+t));m=g(m.original,m.value,r);return[p.concat.apply(p,$jscomp.arrayFromIterable(m)),t]},[[],0])).next().value}function M(a,b,e,g){g=void 0===g?w:g;var l=[];x(a,b).forEach(function(n){l.push({op:"remove",path:e.add(n).toString(),original:a[n]})});x(b,a).forEach(function(n){l.push({op:"add",path:e.add(n).toString(),value:b[n]})});I([a,b]).forEach(function(n){l.push.apply(l,$jscomp.arrayFromIterable(g(a[n],
b[n],e.add(n))))});return l}function w(a,b,e,g){g=void 0===g?w:g;if(a===b)return[];var l=k(a),n=k(b);return"array"==l&&"array"==n?J(a,b,e,g):"object"==l&&"object"==n?M(a,b,e,g):[{op:"replace",path:e.toString(),value:b,original:a}]}function D(a,b,e){Array.isArray(a)?"-"==b?a.push(e):(b=parseInt(b,10),a.splice(b,0,e)):a[b]=e}function E(a,b){Array.isArray(a)?(b=parseInt(b,10),a.splice(b,1)):delete a[b]}function N(a,b){a=q.fromJSON(b.path).evaluate(a);if(null===a.parent)return new v(b.path);if(Array.isArray(a.parent)){if(parseInt(a.key,
10)>=a.parent.length)return new v(b.path)}else if(void 0===a.value)return new v(b.path);a.parent[a.key]=b.value;return null}function O(a,b){switch(b.op){case "add":return a=q.fromJSON(b.path).evaluate(a),void 0===a.parent?b=new v(b.path):(D(a.parent,a.key,h(b.value)),b=null),b;case "remove":return a=q.fromJSON(b.path).evaluate(a),void 0===a.value?b=new v(b.path):(E(a.parent,a.key),b=null),b;case "replace":return N(a,b);case "move":var e=q.fromJSON(b.from).evaluate(a);void 0===e.value?b=new v(b.from):
(a=q.fromJSON(b.path).evaluate(a),void 0===a.parent?b=new v(b.path):(E(e.parent,e.key),D(a.parent,a.key,e.value),b=null));return b;case "copy":return e=q.fromJSON(b.from).evaluate(a),void 0===e.value?b=new v(b.from):(a=q.fromJSON(b.path).evaluate(a),void 0===a.parent?b=new v(b.path):(D(a.parent,a.key,h(e.value)),b=null)),b;case "test":return a=q.fromJSON(b.path).evaluate(a),b=w(a.value,b.value,new q).length?new F(a.value,b.value):null,b}return new G(b)}function P(a){function b(e,g,l){var n=a(e,g,
l);return Array.isArray(n)?n:w(e,g,l,b)}return b}function H(a,b){a=q.fromJSON(b).evaluate(a);if(void 0!==a)return{op:"test",path:b,value:a.value}}var q=function(a){this.tokens=a=void 0===a?[""]:a};q.fromJSON=function(a){var b=a.split("/").map(d);if(""!==b[0])throw Error("Invalid JSON Pointer: "+a);return new q(b)};q.prototype.toString=function(){return this.tokens.map(f).join("/")};q.prototype.evaluate=function(a){for(var b=null,e="",g=1,l=this.tokens.length;g<l;g++)b=a,e=this.tokens[g],a=(b||{})[e];
return{parent:b,key:e,value:a}};q.prototype.get=function(a){return this.evaluate(a).value};q.prototype.set=function(a,b){for(var e=1,g=this.tokens.length-1,l=this.tokens[e];e<g;e++)a=(a||{})[l];a&&(a[this.tokens[this.tokens.length-1]]=b)};q.prototype.push=function(a){this.tokens.push(a)};q.prototype.add=function(a){a=this.tokens.concat(String(a));return new q(a)};var A=Object.prototype.hasOwnProperty,v=function(a){var b=Error.call(this,"Value required at path: "+a);this.message=b.message;"stack"in
...
function(a,b){return b.map(function(e){return O(a,e)})};c.createPatch=function(a,b,e){var g=new q;return(e?P(e):w)(a,b,g)};c.createTests=function(a,b){var e=[];b.filter(u).forEach(function(g){var l=H(a,g.path);l&&e.push(l);"from"in g&&(g=H(a,g.from))&&e.push(g)});return e};Object.defineProperty(c,"__esModule",{value:!0})});
